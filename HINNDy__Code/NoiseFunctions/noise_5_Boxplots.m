...
%             distanceVector = [distanceVector;distance];
            ...
            if sum(forindex == indexToPlot)==1 && i==iteration
                ...
                title(['State X, V = ',num2str(noise_scale)])
                hold off 
                ...
                set(gca,'FontSize',16);
                l=legend('Real Beta ','Prediction');
                l.FontSize = 16;
                l.Location='northeast';
                title(['Prediction with noise = ',num2str(noise_scale)])
                hold off
                ...
                %axis([13 20 -60 80])
                set(gca,'FontSize',16);
                l=legend('Real Beta ','Prediction','Intermediate step');
                l.FontSize = 16;
                l.Location='northeast';
                title(['Noise =',num2str(noise_scale)])
                hold off
                sgtitle(name) 
            end
        end
