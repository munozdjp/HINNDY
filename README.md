...
```
#clone repository
git clone https://github.com/munozdjp/HINNDy.git
...
The extra scripts are complementary validation of HINNDy method. 
...
Here you can find the complete script of [saddle node](https://github.com/munozdjp/HINNDy-/blob/main/HINNDy__Code/SaddleNodeLeft2Rigth.m) 
